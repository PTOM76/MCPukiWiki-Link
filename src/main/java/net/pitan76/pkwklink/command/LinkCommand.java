...
public class LinkCommand extends LiteralCommand {
    ...
    public void init(CommandSettings settings) {
        ...
        addArgumentCommand(new StringCommand() {
            ...
            public void init(CommandSettings settings) {
                ...
                addArgumentCommand(new StringCommand() {
                    ...
                    public void execute(StringCommandEvent e) {
                        ...
                        e.sendSuccess("§5[§aPukiWikiLink§5] §rPukiWikiLink has been linked to " + url + " with token " + masked, false);
                    }
            ...
            @Override
            public void execute(StringCommandEvent e) {
                e.sendSuccess("§5[§aPukiWikiLink§5] §r/pkwklink link <url> <token>", false);
            }
